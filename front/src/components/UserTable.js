  ...
  <Modal.Body>
    <Form>
      <Form.Group className="mb-3" controlId="formBasicEmail">
        ...
        <Form.Control type="text" placeholder={el.fname} name="fname" onChange={handleChange}/>
      </Form.Group>

      <Form.Group className="mb-3" controlId="formBasicPassword">
        <Form.Label>LastName:</Form.Label>
        <Form.Control type="text" placeholder={el.lname} name="lname" onChange={handleChange}/>
      </Form.Group>

      <Form.Group className="mb-3" controlId="formBasicEmail" >
        <Form.Label>ADDRESS:</Form.Label>
        <Form.Control type="text" placeholder={el.address} name="address" onChange={handleChange}/>
      </Form.Group>

      <Form.Group className="mb-3" controlId="formBasicEmail">
        <Form.Label>Phonenumber:</Form.Label>
        <Form.Control type="text" placeholder={el.phonenumber} name="phonenumber" onChange={handleChange} />
      </Form.Group>
